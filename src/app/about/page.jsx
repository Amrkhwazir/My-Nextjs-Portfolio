  ...
  return (
    <motion.div className="h-full text-slate-200" initial={{y: "-200vh"}} animate={{y: "0%"}} transition={{duration: 1.2}}>
      ...
      <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-28 lg:gap-48 xl:gap-64'>
        ...
        <h1 className='font-bold text-2xl bg-gradient-to-t from-sky-400 to-indigo-200 bg-clip-text text-transparent'>BIOGRAPHY</h1>
        ...
        <div className='flex gap-4 flex-wrap'>
          ...
          <div className="rounded p-2 text-sm cursor-pointer bg-slate-200 text-black hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white">Next.js</div>
          <div className="rounded p-2 text-sm cursor-pointer bg-slate-200 text-black hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white">Framer Motion</div>
          <div className="rounded p-2 text-sm cursor-pointer bg-slate-200 text-black hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white">Redux</div>
          <div className="rounded p-2 text-sm cursor-pointer bg-slate-200 text-black hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white">Node.js</div>
          <div className="rounded p-2 text-sm cursor-pointer bg-slate-200 text-black hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white">Express.js</div>
          <div className="rounded p-2 text-sm cursor-pointer bg-slate-200 text-black hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white">MongoDB</div>
          <div className="rounded p-2 text-sm cursor-pointer bg-slate-200 text-black hover:bg-gradient-to-r from-sky-500 to-indigo-500 hover:text-white">Firebase</div>
        ...
        {/* EXPERIENCE TITLE  */}
        <h1 className='font-bold text-2xl bg-gradient-to-t from-sky-400 to-indigo-200 bg-clip-text text-transparent'>EXPERIENCE</h1>
        {/* EXPERIENCE LIST  */}
        <div className="">
        ...
        <div className="w-1 h-full bg-gray-300 relative">
        {/* LINE CIRCLE  */}
        <div className="absolute w-5 h-5 rounded-full ring-4 ring-sky-400 -left-2 bg-white"></div>
        </div>
        </div>
        {/* RIGHT  */}
        <div className="w-1/3">
