          ...
          <div className="relative">
            <svg>
              <defs>
                <path
                id='circlePath'
                d='M 150, 150 m -60, 0 a 60, 0 0,1 120,0 a 60,60 0 0,1 -120,0'
                />
              </defs>
            </svg>
            <Link href="/contact" className='w-16 h-16 md-w-28 md-h-28 absolute top-0 left-0 right-0 bottom-0 m-auto bg-black text-white rounded-full'>Hire Me</Link>
          </div>
        </div>
      </div>
    </div>
